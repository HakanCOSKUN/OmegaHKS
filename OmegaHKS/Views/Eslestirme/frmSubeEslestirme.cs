...
{
    public partial class frmSubeEslestirme : BaseForm
    {
        Logger logger = LogManager.GetCurrentClassLogger();
        //private bool islem = false;
        private Guid PidID;
        public frmSubeEslestirme()
        {
            InitializeComponent();
            InitDTGDoldur();
        ...
        private void InitDTGDoldur()
        {
            ...
            subeDTOList = subeDTOList.Where(s => s.IsyeriTuru == 19).ToList();
        ...
        private IList<Models.LocalSube> GetLocalSubeList()
        {
            ...
            var localDepoController = new Controllers.LocalDepoDTOController();
            logger.Error("Locak Şube Bilgilerini Oku Okumaya Başla");
            result = localDepoController.GetLocalSubeList(Models.DepoSubeAramaTipi.Sube);
            logger.Error("HKS Web Service Okuma Bitti");
            return result;
        }
        ...
        private void rsiBtnEdit_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            Helpers.DepoSubeIslemleri.DepoSubeSecim(true, localNo, Models.DepoSubeAramaTipi.Sube);
